                  ...
                  <div class="price" v-if="item.has_discount">
                     ...
                     <div class="discount">
                        ...
                        <div class="vector vector-one">
                           <nuxt-img format="webp" src="~/assets/images/pricing/cross-shape.png" alt="cross-shape" loading="lazy" />
                        </div>
                     </div>
                     <div class="shape top-0">
                        <nuxt-img format="webp" src="~/assets/images/pricing/shape-two.png" alt="shape" loading="lazy" />
                     </div>
                  </div>
                  <div class="price" v-else>
                     <p><span>${{item.price}}</span></p>
                     <div class="shape">
                        <nuxt-img format="webp" src="~/assets/images/pricing/shape-one.png" alt="shape" loading="lazy" />
                     </div>
                  </div>
                  <div class="card-body">
