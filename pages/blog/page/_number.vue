<template>
  <div class="">
    ...
    <section id="prev-next">
                  <!-- TODO: -->
                  <nav class="blog-pagination" v-if="posts.length > 2">
               <ul class="pagination">
                  <li class="page-item" v-if="posts[posts.length -1 ].hasPrev">
                     <a class="page-link btn btn-secondary" :href="'blog/page/' + (params.number - 1)">
                        <svg
               ...
               {% endfor %}
            -->
                  <li class="page-item" v-if="posts.hasNext">
                     <a class="page-link btn btn-secondary" :href="'blog/page/' + (params.number + 1)">
                        <svg
                           xmlns="http://www.w3.org/2000/svg"
                           width="20.657"
